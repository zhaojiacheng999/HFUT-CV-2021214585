...
def process_an_image(img):
    roi_vtx = np.array(
        [[(0, img.shape[0]), (460, 325), (520, 325), (img.shape[1], img.shape[0])]])  # 目标区域的四个点坐标，roi_vtx是一个三维的数组
...
img = mplimg.imread("assigment2_test.jpg")
...
output = 'assigment2_out.mp4'  # ouput video
clip = VideoFileClip("assigment2_test.mp4")  # input video
